...
void loop() {
  ...
  if ( (millis() - startTime > 5000) && (millis() - startTime < 5050) || (millis() - startTime > 10000) && (millis() - startTime < 10050) || (millis() - startTime > 20000) && (millis() - startTime < 20050)  ) {
    insertFlag = 1;
  }
}
